...
for index, row in df.iterrows():
    key = row["searchSpace"]
    value1 = row["01000-searchTime"]
    value2 = row["01100-searchTime"]
    value3 = row["01001-searchTime"]
    value4 = row["01010-searchTime"]
    value5 = row["01111-searchTime"]
...
plt.tight_layout()
plt.savefig('ablation-greedy-chain-time.pdf', format='pdf')
plt.show()
